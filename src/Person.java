public class Person {
    ...
    public static void main(String[] args) {
        ...
        persArray[2] = new Person("Мельников Андрей Владимирович", "Прораб", "melnikovav@yandex.ru",
                "89643218796", 850000, 36);
        persArray[3] = new Person("Фатеев Антон Игоревич", "Директор", "toha777@gmail.com",
                "89247418525", 200000, 56);
        persArray[4] = new Person("Аверьянов Артур Артёмович", "Инженер-технолог", "averyaa@yandex.ru",
                "893217474", 900000, 31);
